...
//        registry.register(new SimpleModuleFactory(() -> new EmptyModule("antenna")).setRegistryName("antenna"));
        ...
        registry.register(new SimpleModuleFactory(() -> new ModuleSolarPanel(48)).setRegistryName("solar_panel_small"));
        registry.register(new SimpleModuleFactory(() -> new ModuleSolarPanel(128)).setRegistryName("solar_panel_large"));
