...
import net.gegy1000.psf.server.block.production.ContainerAirSeparator;
...
import net.gegy1000.psf.server.block.production.GuiAirSeparator;
...
import net.gegy1000.psf.server.block.production.TileAirSeparator;
...
public class PSFGuiHandler implements IGuiHandler {
    ...
    public static final int ID_AIR_SEPARATOR = 2;
    public static final int ID_KEROSENE_EXTRACTOR = 3;
    ...
    public Object getServerGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        switch (id) {
            ...
            case ID_AIR_COMPRESSOR:
                ...
                break;
            case ID_AIR_SEPARATOR:
                if (entity instanceof TileAirSeparator) {
                    return new ContainerAirSeparator((TileAirSeparator) entity, player.inventory);
                }
                break;
    ...
    public Object getClientGuiElement(int id, EntityPlayer player, World world, int x, int y, int z) {
        ...
        switch (id) {
            ...
            case ID_AIR_SEPARATOR:
                if (entity instanceof TileAirSeparator) {
                    return new GuiAirSeparator(new ContainerAirSeparator((TileAirSeparator) entity, player.inventory));
                }
                break;
            case ID_KEROSENE_EXTRACTOR:
                if (entity instanceof TileKeroseneExtractor) {
