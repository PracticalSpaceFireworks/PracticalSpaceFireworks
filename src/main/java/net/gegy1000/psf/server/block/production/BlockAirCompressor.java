...
public class BlockAirCompressor extends BlockHorizontal implements Machine, RegisterItemModel, RegisterItemBlock, RegisterTileEntity {
    private static final AxisAlignedBB AABB_X = new AxisAlignedBB(0.25, 0.0, 0.0, 0.75, 0.8125, 1.0);
    private static final AxisAlignedBB AABB_Z = new AxisAlignedBB(0.0, 0.0, 0.25, 1.0, 0.8125, 0.75);
    ...
    public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer player, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        ...
        if (!world.isRemote) {
            player.openGui(PracticalSpaceFireworks.getInstance(), PSFGuiHandler.ID_AIR_COMPRESSOR, world, pos.getX(), pos.getY(), pos.getZ());
        }
